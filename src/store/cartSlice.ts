...
const cartSlice = createSlice({
  ...
  reducers: {
    ...
    addAny: (state, action: PayloadAction<{ product: Product; num: number }>) => {
...
export const { setCart, addCount, addAny, lessCount, removeItem, clearCart } = cartSlice.actions;
